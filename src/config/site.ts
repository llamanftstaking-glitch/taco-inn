...
export const site = {
  ...
  images: {
    heroBackground: '/food/tacos-spread.webp',
    storyKitchen: '/food/tortillas-hands.webp',
    interior: '/food/interior.webp',
    birriaTacos: '/food/birria-tacos.webp',
    birriaDunk: '/food/birria-dunk.webp',
    alPastor: '/food/al-pastor.webp',
    alPastor2: '/food/al-pastor-2.webp',
    tacosSpread: '/food/tacos-spread.webp',
    chilaquiles: '/food/chilaquiles.webp',
    tacosOverhead: '/food/tacos-overhead.webp',
    tortillaFire: '/food/tortilla-fire.webp',
    sauceDrip: '/food/sauce-drip.webp',
    steamDark: '/food/steam-dark.webp',
    macroTaco: '/food/macro-taco.webp',
    brothBowl: '/food/broth-bowl.webp',
    pourStream: '/food/pour-stream.webp',
    dipImpact: '/food/dip-impact.webp',
    dipSplash: '/food/dip-splash.webp',
    birriaHero: '/food/birria-hero.webp',
    exteriorNight: '/food/exterior-night.webp',
    tortillasPress: '/food/tortillas-press.webp',
    grillFlames: '/food/grill-flames.webp',
    cilantroPrep: '/food/cilantro-prep.webp',
    consommePot: '/food/consomme-pot.webp',
    cookPlating: '/food/cook-plating.webp',
    quesabirriaPull: '/food/quesabirria-pull.webp',
    tacoTrioOverhead: '/food/taco-trio-overhead.webp',
    molePoblano: '/food/mole-poblano.webp',
    chilaquilesBreakfast: '/food/chilaquiles-breakfast.webp',
    carneAsada: '/food/carne-asada.webp',
    loadedNachos: '/food/loaded-nachos.webp',
    seafood: '/food/seafood.webp',
    tamales: '/food/tamales.webp',
    burritoCross: '/food/burrito-cross.webp',
    salsaTrio: '/food/salsa-trio.webp',
    friendsNight: '/food/friends-night.webp',
    familyDining: '/food/family-dining.webp',
    busyInterior: '/food/busy-interior.webp',
    cheersDrinks: '/food/cheers-drinks.webp',
    firstBite: '/food/first-bite.webp',
    deliveryBag: '/food/delivery-bag.webp',
    openLate: '/food/open-late.webp',
    tableSpread: '/food/table-spread.webp',
  },

  // "Most ordered" hero row. TODO(client): confirm actual best-sellers.
  bestSellers: [
    { name: 'Tacos (Handmade Tortilla)', price: '$3.25', image: '/food/tacos-spread.webp', tagEN: 'House Classic', tagES: 'Clásico' },
    { name: 'Quesabirria + Consomé', price: '$15.00', image: '/food/quesabirria-pull.webp', tagEN: 'Fan Favorite', tagES: 'Favorito' },
    { name: 'Molcajete Inn', price: '$28.00', image: '/food/carne-asada.webp', tagEN: 'For Two', tagES: 'Para Dos' },
    { name: 'Barbacoa (Weekends)', price: '$15.00', image: '/food/broth-bowl.webp', tagEN: 'Weekends Only', tagES: 'Fin de Semana' },
  ],
